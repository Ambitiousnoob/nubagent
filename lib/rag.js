...
function extractQueryPhrases(query, terms) {
...
function queryAwareMatchBoost(query, source, terms) {
...
function lowSignalPagePenalty(source, terms) {
  if (!terms.length) return 0;
...
function domainCrowdingPenalty(domainCounts, domain, source) {
...
function selectSourcesForFetch(searchQuery, sources = [], options = {}) {
...
function rankEvidenceEntriesForQuery(query, entries = [], options = {}) {
