...
const metadataPayload = () => ({
    ...
    memory: {
        ...
        behavior: "Scoped memory is stored server-side. Thin requests can send only the latest turn and the backend will restore compact recent context plus summary from the DB.",
    },
});
